...
class InterNetTester(test_utils.Tester):
    ...
    def define_model(self):
        ...
        if opts.pred_voxels and opts.shape_model:
        ...
        if opts.pred_voxels and (not opts.dwr_model):
            self.model.code_predictor.shape_predictor.add_voxel_decoder(copy.deepcopy(self.voxel_decoder))
