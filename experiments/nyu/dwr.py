...
class DWRTrainer(train_utils.Trainer):
    ...
    def init_dataset(self):
        ...
        self.dataloader = nyu_data.nyu_data_loader(self.split[opts.set], opts)
        ...
        self.spatial_image = Variable(nyu_data.define_spatial_image(opts.img_height_fine, opts.img_width_fine, 1.0/16).unsqueeze(0).cuda())
