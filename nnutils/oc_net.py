...
class OCNet(nn.Module):
    ...
    def add_class_pred(self):
        self.class_predictor = cb.ClassPredictor(self.nz_feat, self.max_object_classes)
        nb.net_init(self.class_predictor)
        return

    def add_class_pred_common(self):
        self.src_class_predictor = cb.ClassPredictor(self.nz_feat, self.max_object_classes)
        nb.net_init(self.src_class_predictor)
        self.trj_class_predictor = cb.ClassPredictor(self.nz_feat, self.max_object_classes)
