...
sunCgDir = osp.join('/scratch/nileshk/nvme-scratch/nileshk/', 'suncg')
    ...
    def run(self):
        for ix in range(nMin-1, nMax):
            if(ix % nCores == self.c):
                ...
                renderCommand = 'cd {}; nice -n 20 {}/scn2img layout.json {} {} {};'.format(modelDir, osp.join(toolboxDir, execFolder), renderFlags, camFile, saveDir)
